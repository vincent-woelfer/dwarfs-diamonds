...
# static var COLOR_A_solid: Color = Color.DARK_GRAY.lightened(0.4)
# static var COLOR_B_solid: Color = Color.SADDLE_BROWN.lightened(0.4)
# static var COLOR_C_solid: Color = Color.DARK_RED.lightened(0.4)

# static var COLOR_A_tunnel: Color = Color.DARK_GRAY.darkened(0.5)
# static var COLOR_B_tunnel: Color = Color.SADDLE_BROWN.darkened(0.5)
# static var COLOR_C_tunnel: Color = Color.DARK_RED.darkened(0.5)
